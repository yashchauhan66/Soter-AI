...
def main():
    ...
    ap.add_argument("--train-datasets", nargs="+", default=["datasets/ml-augmented-v8-final.jsonl", "datasets/ml-v8-targeted-fix.jsonl", "datasets/ml-v10-advanced-attacks.jsonl", "datasets/ml-v10-targeted-fix.jsonl"])
    ap.add_argument("--v7-checkpoint", default="models/ml-classifier-v7/pytorch_model.bin")
    ap.add_argument("--output-dir", default="models/ml-classifier-v10")
    ...
    ap.add_argument("--emb-cache", default="artifacts/ml-v2/v10-final-embeddings.npy")
    args = ap.parse_args()
    ...
    print(f"\n{'='*60}")
    print(f"V10 transfer-learning training complete -> {out_dir}")
    print(f"{'='*60}")
