#!/usr/bin/env python3
"""
Comprehensive V9 Model Test Suite - 5000+ Data Points
Tests the SoterLLM v9 model against diverse attack patterns and benign inputs.
"""
...
# Model paths
MODEL_DIR = Path("models/ml-classifier-v9")
...
def main():
    print("=" * 70)
    print("SoterLLM V9 Comprehensive Test Suite - 5000+ Data Points")
    print("=" * 70)
    ...
    # Save test set
    test_file = Path("artifacts/ml-v2/v9-comprehensive-test-5000.json")
