...
exports.startToolChainSession = startToolChainSession;
...
function checkToolChainStep(options, input) {
    return post(options, "/api/tool-chain/step/check", input);
}
function getToolChainSession(options, sessionId) {
    return get(options, `/api/tool-chain/session/${encodeURIComponent(sessionId)}`);
}
function getToolChainFindings(options, sessionId) {
