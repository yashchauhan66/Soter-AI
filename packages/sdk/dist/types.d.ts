...
export interface ProtectChatOptions {
    ...
    sessionId?: string;
    metadata?: Record<string, MetadataValue>;
    callLLM: (safeMessage: string, context: {
...
export type LineageSourceType = "USER_PROMPT" | "RAG_DOCUMENT" | "BROWSER_PAGE" | "EMAIL" | "FILE" | "MCP_TOOL" | "API_RESPONSE" | "MEMORY" | "CLIPBOARD" | "TERMINAL" | "SYSTEM_PROMPT" | "PRIVATE_CONTEXT" | "CUSTOM";
...
export type LineageDestinationType = "LLM" | "TOOL" | "EXTERNAL_API" | "EMAIL" | "BROWSER_FORM" | "FILE_WRITE" | "MEMORY" | "FINAL_OUTPUT" | "WEBHOOK" | "CUSTOM";
...
export interface SnapshotMcpToolsResponse {
    ...
    drifts: Array<{
        toolName: string;
        driftType: string;
        riskBefore: AgentRiskLevel;
        riskAfter: AgentRiskLevel;
...
export type LegalActionCategory = "READ_ONLY" | "LOGIN" | "FORM_SUBMIT" | "MESSAGE_SEND" | "PURCHASE" | "PAYMENT" | "BOOKING" | "SCRAPING" | "ACCOUNT_CHANGE" | "TERMS_ACCEPTANCE" | "DATA_UPLOAD" | "UNKNOWN";
