"""Shared, transport-agnostic helpers for the Soter Python SDK.
...
from .exceptions import SoterConfigError
from .types import (
    ExcludedRagSource,
    GuardResult,
    LLM_SAFE_ACTIONS,
...
def resolve_config(
    ...
    Raises :class:`SoterConfigError` when no API key can be found.
    """
    key = (
        api_key
