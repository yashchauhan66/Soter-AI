...
const groups = [
  ...
  },
  {
    ...
    items: [
      ...
      { Icon: ShieldCheck, label: "Agent firewall", href: "/dashboard/agent-firewall" },
      { Icon: ShieldCheck, label: "Security badges", href: "/dashboard/badges" },
      { Icon: Globe, label: "Shadow AI", href: "/dashboard/shadow-ai" },
      { Icon: Shield, label: "Red team lab", href: "/dashboard/redteam/lab" },
      { Icon: Wallet, label: "Cost firewall", href: "/dashboard/cost-firewall" },
      { Icon: KeyRound, label: "Credential vault", href: "/dashboard/credentials" },
      { Icon: FileSearch, label: "Forensics", href: "/dashboard/forensics" },
    ],
  },
  {
    ...
    items: [
      ...
      { Icon: Shield, label: "MCP drift", href: "/dashboard/mcp-drift" },
      { Icon: Shield, label: "Legal boundary", href: "/dashboard/legal-boundary" },
    ],
  },
  {
    label: "Agency",
