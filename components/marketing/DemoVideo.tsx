...
const SCENES: Scene[] = [
  ...
  {
    id: "benchmark",
    title: "Public Benchmark: 100% Recall on Synthetic Dataset",
    subtitle: "2,200 synthetic attacks and 1,000 benign controls measured with the production detector",
    userMessage: "",
    status: "ALLOWED",
    riskScore: 0,
    riskTypes: [],
    verdict: "Self-maintained benchmark results published with methodology and limitations.",
    detailLines: [
      "100% recall on the published Phase 9 synthetic benchmark dataset",
      "1,000/1,000 benign controls allowed in the latest generated run",
      "10 categories including prompt injection, jailbreak, RAG poisoning, MCP risk, secrets, and PII",
    ],
