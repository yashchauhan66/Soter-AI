...
const SCENES: Scene[] = [
  ...
  {
    id: "benchmark",
    title: "Adversarial Benchmark: 84% Recall @ 1% FPR",
    subtitle: "84% of attack variants caught within a 1% false-positive budget (0.54% FPR)",
    userMessage: "",
    status: "ALLOWED",
    riskScore: 0,
    riskTypes: [],
    ...
    detailLines: [
      "84% of adversarial prompts caught within a 1% false-positive budget",
      "1,104/1,110 benign inputs correctly allowed (0.54% false-positive rate)",
