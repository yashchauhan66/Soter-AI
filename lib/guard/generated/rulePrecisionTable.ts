...
export const RULE_PRECISION: RulePrecisionTable = {
  ...
  { label: "Agent escalation or RCE attempt (compact)", riskType: "PROMPT_INJECTION", benignFireRate: 0.0042, attackFireRate: 0.02311, lift: 5.25 },
  { label: "Educational pretext jailbreak (generalized)", riskType: "JAILBREAK", benignFireRate: 0.0032, attackFireRate: 0.00269, lift: 0.79 },
  { label: "Direct explosive construction inquiry", riskType: "TOXICITY", benignFireRate: 0.003, attackFireRate: 0.00537, lift: 1.68 },
  ...
  { label: "Agent escalation or RCE attempt", riskType: "PROMPT_INJECTION", benignFireRate: 0.0026, attackFireRate: 0.02096, lift: 7.49 },
  ...
  { label: "Direct drug synthesis inquiry", riskType: "TOXICITY", benignFireRate: 0.0018, attackFireRate: 0.00967, lift: 4.84 },
  { label: "Agent escalation or RCE attempt (leet)", riskType: "PROMPT_INJECTION", benignFireRate: 0.0016, attackFireRate: 0.01505, lift: 8.36 },
  ...
  { label: "Many-shot conditioning jailbreak (generalized)", riskType: "JAILBREAK", benignFireRate: 0.0014, attackFireRate: 0.01397, lift: 8.73 },
  ...
  { label: "Doxxing or targeted harassment request", riskType: "TOXICITY", benignFireRate: 0.0008, attackFireRate: 0.00269, lift: 2.69 },
  ...
  { label: "Adaptive jailbreak optimizer", riskType: "PROMPT_INJECTION", benignFireRate: 0.0006, attackFireRate: 0.0043, lift: 5.37 },
  { label: "Adaptive jailbreak optimizer (compact)", riskType: "PROMPT_INJECTION", benignFireRate: 0.0006, attackFireRate: 0.00322, lift: 4.03 },
  ...
  { label: "Model supply-chain risk", riskType: "MODEL_SUPPLY_CHAIN", benignFireRate: 0.0006, attackFireRate: 0.00107, lift: 1.34 },
  ...
  { label: "Jailbreak persona override", riskType: "PROMPT_INJECTION", benignFireRate: 0.0004, attackFireRate: 0.03224, lift: 53.75 },
  { label: "Jailbreak persona override (leet)", riskType: "PROMPT_INJECTION", benignFireRate: 0.0004, attackFireRate: 0.02848, lift: 47.48 },
  ...
  { label: "Adaptive jailbreak optimizer (leet)", riskType: "PROMPT_INJECTION", benignFireRate: 0.0002, attackFireRate: 0.00322, lift: 8.06 },
