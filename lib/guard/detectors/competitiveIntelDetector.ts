...
const rules: PatternRule[] = [
  ...
  { pattern: /(?:what (?:is|are)|share|reveal|tell me)\s*(?:your|the|this company's)?\s*(?:(?:exact|current|actual|real|internal)\s*)?(?:ARR|MRR|churn rate|LTV|CAC|burn rate|runway|valuation|revenue|GMV|DAU|MAU|NPS|retention rate|conversion rate)/i, label: "Internal KPI extraction", message: "Attempt to extract confidential business metrics.", severity: "HIGH", score: 45 },
