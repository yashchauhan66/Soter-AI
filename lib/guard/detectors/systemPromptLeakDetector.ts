...
const inputRules: PatternRule[] = [
  { pattern: /(?:show|reveal|print|expose|repeat|what\s+are) (?:your |the )?(?:hidden |confidential |internal |developer |system )*(?:prompt|message|instructions?|rules?|configuration)/i, label: "System prompt request", message: "Requests confidential model instructions.", severity: "HIGH", score: 45 },
