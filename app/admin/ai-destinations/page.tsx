...
export default async function AdminAIDestinationsPage() {
  ...
  if (!organizationId) return <div className="rounded-xl border border-slate-800 p-6"><h1 className="text-2xl font-bold">AI destinations</h1><p className="mt-2 text-sm text-slate-200">Create an organization before configuring destination controls.</p></div>;
