...
export default function DemoChatbotPage() { return <main className="container-page py-16"><div className="mx-auto mb-10 max-w-3xl text-center"><p className="eyebrow">Before and after</p><h1 className="mt-3 text-4xl font-bold">Watch a chatbot flow change with a guard.</h1><p className="mt-4 text-lg leading-8 text-slate-200">This simulation demonstrates blocking and redaction without sending content to an external AI provider.</p></div><DemoChatClient/></main>; }
