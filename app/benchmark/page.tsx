      ...
      <div className="container-page">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="card p-5">
            ...
            <p className="text-sm text-slate-200">Latest recall</p>
          </div>
          <div className="card p-5">
            ...
            <p className="text-sm text-slate-200">False-positive rate</p>
          </div>
          <div className="card p-5">
            ...
            <p className="text-sm text-slate-200">Dataset rows</p>
          </div>
          <div className="card p-5">
            ...
            <p className="text-sm text-slate-200">p95 latency</p>
          </div>
        </div>
              ...
              <tbody>
                {categories.map(([category, row]) => (
                  <tr className="border-t border-slate-800" key={category}>
                    ...
                    <td className="p-3 text-slate-200">{row.detected}/{row.total}</td>
                    <td className="p-3 text-slate-200">{pct(row.recall)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section className="mt-10">
          ...
          <p className="mt-3 text-sm text-slate-200">2026-07-15: Phase 9 public benchmark dataset, runner, and results page added.</p>
        </section>
      </div>
    </main>
  );
