...
export default function RagSecurityPage() {
  ...
  return (
    <div>
      <p className="eyebrow">RAG security</p>
      <h1 className="mt-2 text-3xl font-bold">Advanced retrieval attack defenses</h1>
      <p className="mt-3 max-w-3xl text-slate-400">Defensive tests cover indirect prompt injection, private chunk leakage, citation spoofing, retrieval manipulation, low-trust sources, and no-source high-risk answers.</p>
