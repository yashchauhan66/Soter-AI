...
const marketingPages = [
  ...
  { url: "/benchmarks", priority: 0.9, changeFrequency: "monthly" as const },
  { url: "/comparison", priority: 0.9, changeFrequency: "monthly" as const },
...
// Legal / trust pages
const legalPages = [
  { url: "/trust", priority: 0.5, changeFrequency: "monthly" as const },
  ...
  { url: "/data-retention", priority: 0.3, changeFrequency: "yearly" as const },
  { url: "/responsible-disclosure", priority: 0.3, changeFrequency: "yearly" as const },
  { url: "/subprocessors", priority: 0.3, changeFrequency: "yearly" as const },
...
const docsPages = [
  ...
  { url: "/docs/quickstart", priority: 0.7, changeFrequency: "monthly" as const },
  { url: "/docs/js", priority: 0.6, changeFrequency: "monthly" as const },
  { url: "/docs/python", priority: 0.6, changeFrequency: "monthly" as const },
  { url: "/docs/nextjs", priority: 0.6, changeFrequency: "monthly" as const },
  { url: "/docs/rest-api", priority: 0.6, changeFrequency: "monthly" as const },
  { url: "/docs/rag", priority: 0.6, changeFrequency: "monthly" as const },
  { url: "/docs/fastapi", priority: 0.5, changeFrequency: "monthly" as const },
  { url: "/docs/express", priority: 0.5, changeFrequency: "monthly" as const },
  ...
  { url: "/docs/generic-chatbot", priority: 0.5, changeFrequency: "monthly" as const },
  { url: "/docs/cli", priority: 0.5, changeFrequency: "monthly" as const },
  { url: "/docs/best-practices", priority: 0.5, changeFrequency: "monthly" as const },
  { url: "/docs/api-contract", priority: 0.4, changeFrequency: "monthly" as const },
];
