...
export default function EnterprisePilotPage(){return <main className="container-page py-16"><p className="eyebrow">Enterprise pilot</p><h1 className="mt-2 text-4xl font-bold">Define a measurable AI security pilot</h1><p className="mb-10 mt-4 max-w-3xl text-slate-200">A pilot covers scoped integration, authorized defensive validation, OWASP LLM Top 10 alignment review, SIEM setup where required, and a final recommendation. It does not authorize testing third-party systems.</p><div className="max-w-4xl"><PilotRequestForm /></div></main>}
