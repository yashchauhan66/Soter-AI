...
export default function SecurityPage() {
  return (
    <ReadinessPage title="Security Overview">
      <p>SoterAI protects company data and AI-agent actions across browsers, IDEs, workflows, and APIs before sensitive context reaches external AI systems.</p>
      ...
      <p>SOC2 readiness is in progress. External pentest evidence is required before any pentest-verified or enterprise GA security claim. Security is operated as defense-in-depth; no public page should be read as a promise of complete protection.</p>
    </ReadinessPage>
  );
}
