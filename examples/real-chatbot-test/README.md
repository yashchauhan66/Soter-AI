...
This is a minimal Express + TypeScript chatbot application to verify the `@soterai/core` SDK integration, LLM response handling, and plan billing limits (Free and Pro plans).
